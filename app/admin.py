...
# admin interface
admin.site.site_header = 'Hệ thống thông tin EndCovi | Chung tay chấm dứt Covid'
admin.site.site_title = 'Hệ thống thông tin EndCovi | Chung tay chấm dứt Covid'
admin.index_title = 'Hệ thống thông tin EndCovi | Chung tay chấm dứt Covid'
admin.site_url = '/'
